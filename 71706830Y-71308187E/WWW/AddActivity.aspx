<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddActivity.aspx.cs" Inherits="WWW.AddActivity" UnobtrusiveValidationMode="None" %>
...
<body>
    <form id="formAddActivity" runat="server">
        <div class="form-card">
            ...
            <div class="form-group">
                ...
                <asp:DropDownList ID="ddlActivityType" runat="server" CssClass="form-control" OnSelectedIndexChanged="ddlActivityType_SelectedIndexChanged" AutoPostBack="true">
                ...
                <asp:RequiredFieldValidator ID="rfvActivityType" runat="server" ControlToValidate="ddlActivityType"
                    ErrorMessage="Debes seleccionar un tipo de actividad." CssClass="validation-error" Display="Dynamic"></asp:RequiredFieldValidator>
            </div>

            <div class="form-group">
                <asp:Label ID="lblName" runat="server" Text="Nombre de la Actividad (Ej: Carrera matutina)" CssClass="form-label"></asp:Label>
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <asp:RequiredFieldValidator ID="rfvStartTime" runat="server" ControlToValidate="txtStartTime"
                        ErrorMessage="La fecha de inicio es obligatoria." CssClass="validation-error" Display="Dynamic"></asp:RequiredFieldValidator>
                </div>
                <div class="form-group">
                    ...
                    <asp:RequiredFieldValidator ID="rfvDuration" runat="server" ControlToValidate="txtDuration"
                        ErrorMessage="La duración es obligatoria." CssClass="validation-error" Display="Dynamic"></asp:RequiredFieldValidator>
                    <asp:RangeValidator ID="rvDuration" runat="server" ControlToValidate="txtDuration" Type="Integer" MinimumValue="1" MaximumValue="99999"
                        ErrorMessage="La duración debe ser mayor que cero." CssClass="validation-error" Display="Dynamic"></asp:RangeValidator>
                </div>
            </div>
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <asp:RequiredFieldValidator ID="rfvDistance" runat="server" ControlToValidate="txtDistance"
                            ErrorMessage="La distancia es obligatoria." CssClass="validation-error" Display="Dynamic"></asp:RequiredFieldValidator>
                    </div>
                    <div class="form-group">
            ...
            <asp:Panel ID="pnlSwimming" runat="server" Visible="false" CssClass="specific-panel">
                 <div class="form-row">
                    <div class="form-group">
                        ...
                        <asp:RequiredFieldValidator ID="rfvSwimDistance" runat="server" ControlToValidate="txtSwimDistance"
                            ErrorMessage="La distancia es obligatoria." CssClass="validation-error" Display="Dynamic"></asp:RequiredFieldValidator>
                    </div>
                    <div class="form-group">
            ...
            <asp:Panel ID="pnlOther" runat="server" Visible="false" CssClass="specific-panel">
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <asp:RequiredFieldValidator ID="rfvOtherActivity" runat="server" ControlToValidate="txtOtherActivity"
                            ErrorMessage="El nombre es obligatorio." CssClass="validation-error" Display="Dynamic"></asp:RequiredFieldValidator>
                    </div>
                     <div class="form-group">
            ...
            <div class="btn-container">
                <asp:Button ID="btnSave" runat="server" Text="Guardar Actividad" OnClick="btnSave_Click" CssClass="btn btn-primary" />
